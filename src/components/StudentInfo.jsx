        ...
        <div className="flex">
          <div className="mr-12">
            <div className="w-[120px] h-[120px] bg-gray-200 rounded-full overflow-hidden">
              <img src="/student-photo.jpg" alt="Student Photo" className="w-full h-full object-cover" />
            </div>
          </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="bg-gray-100 rounded-3xl p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="text-sm">Đơn gia hạn hợp đồng đã được phê duyệt</div>
              <div className="text-xs text-gray-500">3 ngày trước</div>
            </div>
            <div>
              <div className="text-sm">Đã gửi phiếu đăng ký gia hạn hợp đồng</div>
        ...
        <div className="bg-gray-100 rounded-3xl p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="text-sm">Đã tiếp nhận phản ánh trực tuyến</div>
              <div className="text-xs text-gray-500">2 tháng trước</div>
            </div>
            <div>
              <div className="text-sm">Đã gửi phiếu phản ánh trực tuyến</div>
              <div className="text-xs text-gray-500">2 tháng trước</div>
            </div>
          </div>
        </div>
